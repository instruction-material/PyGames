...
def draw():
    ...
    if lives > 0:
        ...
        mod.screen.draw.text(
            "Lives: ", center=(35, 25), fontsize=30, color=(255, 255, 255)
        )
        mod.screen.draw.text(
            str(lives), center=(40, 55), fontsize=30, color=(255, 255, 255)
        )
    else:
        mod.screen.draw.text(
            "GAME OVER", center=(250, 200), fontsize=100, color=(255, 255, 255)
        )
